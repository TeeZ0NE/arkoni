...
Donec lacinia condimentum tortor eget posuere.</p>',
    ...
    'services' => [
        'block-1' => [
            'title' => 'Розрахувати вартість ремонту - легко!',
    ...
    'comments' => [
        ...
        'name-1' => 'Вадим, прораб',
        'title-1' => 'Удобное расположение',
        'comment-1' => 'Душа моя озарена неземной радостью, как эти чудесные весенние утра, которыми я наслаждаюсь от всего сердца. Я совсем один и блаженствую в здешнем краю, словно созданном для таких, как я. Я так счастлив, мой друг, так упоен ощущением покоя, что искусство мое страдает от этого. ',
    ],
    ...
    'google-map' => [
        ...
        'address' => 'пер. Цегельный, 2  г. Винница',
        'work' => 'Працюємо для Вас',
        'work-time' => 'Пн. - Пт. 08:30 - 17:30<br>Сб., Нд. - вихідні',
