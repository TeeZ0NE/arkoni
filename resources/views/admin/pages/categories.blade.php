@extends('admin.admin')@section('title','Категорії')@section('description','myDescription to categories info')@section('keywords','myKeyWords to Categories info')@section('admin_main_content')
	...
	<div class="row">
		<div class="col-12 col-lg-2">
			...
			<br>
			<a href="{{ route('cats.create') }}" class="btn btn-warning" role="button">
				...
				<tbody>@foreach ($cats as $cat)
					<tr>
						...
						<td class="text-right align-middle">
							...
							<a href="{{route('cat.destroy',$cat->id)}}" class="btn btn-secondary ml-1"
