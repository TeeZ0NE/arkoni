...
@section('content')
                ...
                <div class="filters d-lg-none">
                    <form method="get" action="{{ route('sub-category',substr($segment,2)) }}" role="search">
                        ...
                        <div class="parameters-block">
                            ...
                            <button type="submit"
                                    class="btn btn-filter d-none d-lg-block">@lang('general.show')</button>
                        </div>
                        <button type="submit" class="btn btn-filter d-lg-none">@lang('general.show')</button>
                    </form>
                </div>
    ...
    <div class="seo-block-2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="title">{{ $scat->$scat_method['h2'] }}</h2>
                    {!! $scat->$scat_method['seo_text_2'] !!}
                </div>
            </div>
        </div>
    </div>
